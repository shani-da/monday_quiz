...
// category      
   ...
   if (String(temp) == "True" || String(temp) == "False" || String(currentQuestion.type) == "boolean" || currentQuestion.type == "boolean" || document.getElementById('choice4').textContent == "undefined"){
